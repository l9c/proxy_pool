...
def runScheduler():
    ...
    scheduler.add_job(rawProxyScheduler, 'interval', minutes=200, id="raw_proxy_check", name="raw_proxy定时采集")
    scheduler.add_job(usefulProxyScheduler, 'interval', minutes=30, id="useful_proxy_check", name="useful_proxy定时检查")
